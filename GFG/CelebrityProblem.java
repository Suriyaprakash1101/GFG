...
Difficulty: MediumAccuracy: 38.33%Submissions: 343K+Points: 4Average Time: 30m
...
class Solution {
    public int celebrity(int mat[][]) {
        // code here
        int[]IKnow=new int[mat.length]; //person known by me
         int[]personKnowMe=new int[mat.length]; //num of person know me
         ...
         for(int i=0;i<mat.length;i++){
             if(IKnow[i]==0&&personKnowMe[i]==mat.length-1){
                 return i;
             }
         }
         return -1;
